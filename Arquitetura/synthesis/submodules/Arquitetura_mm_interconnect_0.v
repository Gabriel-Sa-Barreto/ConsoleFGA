...
module Arquitetura_mm_interconnect_0 (
		...
		output wire [1:0]  printting_s1_address,                           //                             printting_s1.address
		input  wire [31:0] printting_s1_readdata,                          //                                         .readdata
	...
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // switch_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [93:0] data_a_s1_agent_rf_source_data;                                                     // data_A_s1_agent:rf_source_data -> data_A_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] data_a_s1_agent_rsp_fifo_out_data;                                                  // data_A_s1_agent_rsp_fifo:out_data -> data_A_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> data_A_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // data_A_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> data_A_s1_agent:cp_channel
	...
	wire  [93:0] data_b_s1_agent_rf_source_data;                                                     // data_B_s1_agent:rf_source_data -> data_B_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] data_b_s1_agent_rsp_fifo_out_data;                                                  // data_B_s1_agent_rsp_fifo:out_data -> data_B_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> data_B_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // data_B_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> data_B_s1_agent:cp_channel
	...
	wire  [31:0] printting_s1_agent_m0_readdata;                                                     // printting_s1_translator:uav_readdata -> printting_s1_agent:m0_readdata
	wire         printting_s1_agent_m0_waitrequest;                                                  // printting_s1_translator:uav_waitrequest -> printting_s1_agent:m0_waitrequest
	wire         printting_s1_agent_m0_debugaccess;                                                  // printting_s1_agent:m0_debugaccess -> printting_s1_translator:uav_debugaccess
	wire  [16:0] printting_s1_agent_m0_address;                                                      // printting_s1_agent:m0_address -> printting_s1_translator:uav_address
	wire   [3:0] printting_s1_agent_m0_byteenable;                                                   // printting_s1_agent:m0_byteenable -> printting_s1_translator:uav_byteenable
	wire         printting_s1_agent_m0_read;                                                         // printting_s1_agent:m0_read -> printting_s1_translator:uav_read
	wire         printting_s1_agent_m0_readdatavalid;                                                // printting_s1_translator:uav_readdatavalid -> printting_s1_agent:m0_readdatavalid
	wire         printting_s1_agent_m0_lock;                                                         // printting_s1_agent:m0_lock -> printting_s1_translator:uav_lock
	wire  [31:0] printting_s1_agent_m0_writedata;                                                    // printting_s1_agent:m0_writedata -> printting_s1_translator:uav_writedata
	wire         printting_s1_agent_m0_write;                                                        // printting_s1_agent:m0_write -> printting_s1_translator:uav_write
	wire   [2:0] printting_s1_agent_m0_burstcount;                                                   // printting_s1_agent:m0_burstcount -> printting_s1_translator:uav_burstcount
	wire         printting_s1_agent_rf_source_valid;                                                 // printting_s1_agent:rf_source_valid -> printting_s1_agent_rsp_fifo:in_valid
	wire  [93:0] printting_s1_agent_rf_source_data;                                                  // printting_s1_agent:rf_source_data -> printting_s1_agent_rsp_fifo:in_data
	wire         printting_s1_agent_rf_source_ready;                                                 // printting_s1_agent_rsp_fifo:in_ready -> printting_s1_agent:rf_source_ready
	wire         printting_s1_agent_rf_source_startofpacket;                                         // printting_s1_agent:rf_source_startofpacket -> printting_s1_agent_rsp_fifo:in_startofpacket
	wire         printting_s1_agent_rf_source_endofpacket;                                           // printting_s1_agent:rf_source_endofpacket -> printting_s1_agent_rsp_fifo:in_endofpacket
	wire         printting_s1_agent_rsp_fifo_out_valid;                                              // printting_s1_agent_rsp_fifo:out_valid -> printting_s1_agent:rf_sink_valid
	wire  [93:0] printting_s1_agent_rsp_fifo_out_data;                                               // printting_s1_agent_rsp_fifo:out_data -> printting_s1_agent:rf_sink_data
	wire         printting_s1_agent_rsp_fifo_out_ready;                                              // printting_s1_agent:rf_sink_ready -> printting_s1_agent_rsp_fifo:out_ready
	wire         printting_s1_agent_rsp_fifo_out_startofpacket;                                      // printting_s1_agent_rsp_fifo:out_startofpacket -> printting_s1_agent:rf_sink_startofpacket
	wire         printting_s1_agent_rsp_fifo_out_endofpacket;                                        // printting_s1_agent_rsp_fifo:out_endofpacket -> printting_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> printting_s1_agent:cp_valid
	wire  [92:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> printting_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // printting_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> printting_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> printting_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> printting_s1_agent:cp_endofpacket
	...
	wire  [92:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] data_a_s1_agent_rp_data;                                                            // data_A_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [92:0] data_b_s1_agent_rp_data;                                                            // data_B_s1_agent:rp_data -> router_008:sink_data
	...
	wire         printting_s1_agent_rp_valid;                                                        // printting_s1_agent:rp_valid -> router_009:sink_valid
	wire  [92:0] printting_s1_agent_rp_data;                                                         // printting_s1_agent:rp_data -> router_009:sink_data
	wire         printting_s1_agent_rp_ready;                                                        // router_009:sink_ready -> printting_s1_agent:rp_ready
	wire         printting_s1_agent_rp_startofpacket;                                                // printting_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         printting_s1_agent_rp_endofpacket;                                                  // printting_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         printting_s1_agent_rdata_fifo_src_valid;                                            // printting_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] printting_s1_agent_rdata_fifo_src_data;                                             // printting_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         printting_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_007:in_0_ready -> printting_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> printting_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> printting_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // printting_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> printting_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) printting_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (printting_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (printting_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (printting_s1_agent_m0_read),                     //                         .read
		.uav_write              (printting_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (printting_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (printting_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (printting_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (printting_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (printting_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (printting_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (printting_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (printting_s1_address),                           //      avalon_anti_slave_0.address
		.av_readdata            (printting_s1_readdata),                          //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
		.av_writedata           (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (printting_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (printting_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (printting_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (printting_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (printting_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (printting_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (printting_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (printting_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (printting_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (printting_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (printting_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (printting_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (printting_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (printting_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (printting_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (printting_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (printting_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (printting_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (printting_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (printting_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (printting_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (printting_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (printting_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (printting_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (printting_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (printting_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),              //                .error
		.rdata_fifo_src_ready    (printting_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (printting_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (printting_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) printting_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (printting_s1_agent_rf_source_data),              //        in.data
		.in_valid          (printting_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (printting_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (printting_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (printting_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (printting_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (printting_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (printting_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (printting_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (printting_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	Arquitetura_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (printting_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (printting_s1_agent_rp_valid),                    //          .valid
		.sink_data          (printting_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (printting_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (printting_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Arquitetura_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (printting_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (printting_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (printting_s1_agent_rdata_fifo_src_ready),        //         .ready
