...
module collenda_mm_interconnect_0 (
		...
		input  wire        check_print_reset_reset_bridge_in_reset_reset,      //      check_print_reset_reset_bridge_in_reset.reset
		input  wire        nios2_gen2_0_reset_reset_bridge_in_reset_reset,     //     nios2_gen2_0_reset_reset_bridge_in_reset.reset
		input  wire        pushbutton_reset_reset_reset_bridge_in_reset_reset, // pushbutton_reset_reset_reset_bridge_in_reset.reset
	...
	wire  [13:0] check_print_s1_agent_m0_address;                                                    // check_print_s1_agent:m0_address -> check_print_s1_translator:uav_address
	...
	wire  [90:0] check_print_s1_agent_rf_source_data;                                                // check_print_s1_agent:rf_source_data -> check_print_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] check_print_s1_agent_rsp_fifo_out_data;                                             // check_print_s1_agent_rsp_fifo:out_data -> check_print_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> check_print_s1_agent:cp_valid
	wire  [89:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> check_print_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // check_print_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> check_print_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> check_print_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> check_print_s1_agent:cp_endofpacket
	...
	wire  [13:0] pushbutton_reset_s1_agent_m0_address;                                               // pushbutton_reset_s1_agent:m0_address -> pushbutton_reset_s1_translator:uav_address
	...
	wire  [90:0] pushbutton_reset_s1_agent_rf_source_data;                                           // pushbutton_reset_s1_agent:rf_source_data -> pushbutton_reset_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] pushbutton_reset_s1_agent_rsp_fifo_out_data;                                        // pushbutton_reset_s1_agent_rsp_fifo:out_data -> pushbutton_reset_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pushbutton_reset_s1_agent:cp_valid
	wire  [89:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pushbutton_reset_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // pushbutton_reset_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pushbutton_reset_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pushbutton_reset_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pushbutton_reset_s1_agent:cp_endofpacket
	...
	wire         check_print_s1_agent_rp_valid;                                                      // check_print_s1_agent:rp_valid -> router_005:sink_valid
	wire  [89:0] check_print_s1_agent_rp_data;                                                       // check_print_s1_agent:rp_data -> router_005:sink_data
	wire         check_print_s1_agent_rp_ready;                                                      // router_005:sink_ready -> check_print_s1_agent:rp_ready
	wire         check_print_s1_agent_rp_startofpacket;                                              // check_print_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         check_print_s1_agent_rp_endofpacket;                                                // check_print_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         pushbutton_reset_s1_agent_rp_valid;                                                 // pushbutton_reset_s1_agent:rp_valid -> router_006:sink_valid
	wire  [89:0] pushbutton_reset_s1_agent_rp_data;                                                  // pushbutton_reset_s1_agent:rp_data -> router_006:sink_data
	wire         pushbutton_reset_s1_agent_rp_ready;                                                 // router_006:sink_ready -> pushbutton_reset_s1_agent:rp_ready
	wire         pushbutton_reset_s1_agent_rp_startofpacket;                                         // pushbutton_reset_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pushbutton_reset_s1_agent_rp_endofpacket;                                           // pushbutton_reset_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         check_print_s1_agent_rdata_fifo_src_valid;                                          // check_print_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] check_print_s1_agent_rdata_fifo_src_data;                                           // check_print_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         check_print_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_003:in_0_ready -> check_print_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> check_print_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> check_print_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // check_print_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> check_print_s1_agent:rdata_fifo_sink_error
	wire         pushbutton_reset_s1_agent_rdata_fifo_src_valid;                                     // pushbutton_reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pushbutton_reset_s1_agent_rdata_fifo_src_data;                                      // pushbutton_reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pushbutton_reset_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_004:in_0_ready -> pushbutton_reset_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> pushbutton_reset_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> pushbutton_reset_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // pushbutton_reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> pushbutton_reset_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (check_print_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                      //                      clk.clk
		.reset                  (pushbutton_reset_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (check_print_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                        //             clk.clk
		.reset                   (pushbutton_reset_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	collenda_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (check_print_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
	...
	collenda_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                      // in_clk_0.clk
		.in_rst_0_reset (pushbutton_reset_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
