...
def rom_12_bit(name, im, mask=False, rem_x=-1, rem_y=-1):
    ...
    row_width = int( math.ceil(math.log(y_max-1,2)) )
    col_width = int( math.ceil(math.log(x_max-1,2)) )
...
maxSprite = 16
for max in range(1,maxSprite):
    generate("Walk" + str(max) + ".png")
